...
import com.filter.bloom.hash.impl.SHA256HashAlgorithm;
import com.filter.bloom.hash.impl.SHA512HashAlgorithm;
...
public class BloomFilter {
	...
	private static HashFunction[] HASH_FUNCTIONS = { new MD5HashAlgorithm(),
	        new SHA1HashAlgorithm(), new SHA256HashAlgorithm(),
	 ...
	 * @param String
	 *            - the word
	 * @return boolean - whether the word is disallowed or not.
	 * @throws UnsupportedEncodingException
	 */
